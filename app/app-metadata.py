...
# Define UI
def get_doc_choices():
    return [(doc_id, doc.metadata.get("filename", doc_id)) 
    ...
    def display_panel():
        ...
        try:
            ...
            return ui.div(
                ...
                ui.row(
                    ui.column(6,  # Left column (PDF)
                        ui.h4("PDF View"),
                        ui.tags.iframe(
                            src=pdf_data_url,
                            style="width: 100%; height: 800px; border: 1px solid #ddd;",
                            type="application/pdf",
                        ) if pdf_data_url else ui.p("No PDF available")
                    ),
                    ui.column(6,  # Right column (Markdown)
                        ui.h4("Content"),
                        ui.div(
